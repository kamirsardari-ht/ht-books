<?php
include 'wp-content/plugins/easy-digital-downloads/includes/checkout/functions.php';
/**
...
function redirect_login_page() {
	$login_page='http://hilltimes.com/HT-books/';
...
function login_failed() {
	//$login_page=get_permalink( 36245 );
	$login_page='http://hilltimes.com/HT-books/?page_id=73';
    //$login_page  = home_url( '/login/' );
...
function pippin_edd_purchase_details($payment_meta, $user_info) {
	...
	?>
	<li><?php echo __('Phoneeeeeeeeeeee0000000000:', 'pippin_edd') . ' ' . $phone; ?></li>
