...
$( document ).ready(function() {
    //console.log( "ready!" );
    //alert('hello');
    //$('#edd_checkout_user_info legend:first-child').text('Billing Info');
    $('#edd_checkout_user_info legend:first-child').text('Billing Info');
    
    $('#edd_cc_address legend:first-child').text('Shipping Details');
    $( "#edd_cc_address" ).hide();
    //$( "#edd_simple_shipping_fields" ).show();
    $("#edd_simple_shipping_fields_wrap").css("display", "block");
    $("#edd_simple_shipping_diff_address").css("display", "none");
    //$("#edd_register_fields #edd-phone-wrap").css("display", "none");
    //$("#edd_register_fields #edd-company-wrap").css("display", "none");
